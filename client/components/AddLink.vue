<template>
    <div id="AddLink" class="w-full bg-white rounded-3xl overflow-hidden">
        ...
        <form @submit.prevent="submit()" class="flex items-center gap-4 w-full pt-2 p-6">
            <div class="w-full">
            ...
            <button type="submit" :disabled="!name && ! url"
                @click="addLink()" class="rounded-full p-3 px-6"
                :class="name && url ? 'bg-[#8228d9] hover:bg-[#6c21b3] text-white' 
